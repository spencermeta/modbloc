...
const InsightCard = (props) => (
  <motion.div variants={fadeIn("up", "spring", props.index * 0.5, 1)} className="flex md:flex-row flex-col gap-4">
    {/* <Image src={props.imgUrl} width="0"  alt="planeta1" className="md:w-[270px] w-full h-[250px] rounded-[32px] object-cover" /> */}

    <div className="w-full flex justify-between items-center">
      <div className="flex-1 md:ml-[62px] flex flex-col max-w-[650px]">
        <h4 className="font-normal lg:text-[42px] text-[26px] text-white">{props.title}</h4>
        <p className="mt-[16px] font-normal lg:text-[20px] text-[14px] text-secondary-white">{props.subtitle}</p>
      </div>
    </div>
